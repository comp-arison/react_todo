    ...
    <section className="bootstrap">
      <main>
        ...
        <Container>
          <Row>
            ...
            <Accordion defaultActiveKey='0' className="m-4">
              <Accordion.Item eventKey='0'>
                ...
                <Accordion.Body>
                  <p>
                    Install both bootstrap and react-bootstrap with 'npm install bootstrap react-bootstrap'
                  </p>
                </Accordion.Body>
              </Accordion.Item>
          ...
          <Row className="text-center m-2">
            <Col md={4} className="alert alert-primary">
              <h4>
                col-md-4
                <hr />
                will take up 4 of 12 columns in the grid
              </h4>
            </Col>
            ...
            <Col md={2} className="alert alert-success">
              <h4>
                col-md-2
                <hr />
                will take up 2 of 12 columns in the grid
              </h4>
            </Col>
          </Row>
          <Row className="text-center m-2">
          ...
          <Row className='text-center m-2'>
            <Col xl={2} lg={3} md={6} className="border border-success">Breakpoints example</Col>
            <Col xl={2} lg={3} md={6} className="border border-success">Breakpoints example</Col>
            <Col xl={2} lg={3} md={6} className="border border-success">Breakpoints example</Col>
            <Col xl={2} lg={3} md={6} className="border border-success">Breakpoints example</Col>
            <Col xl={2} lg={3} md={6} className="border border-success">Breakpoints example</Col>
